...
/// ```
DistinctValueConnectableObservable<T> publishValueDistinct<T>(
  Observable<T> this$, {
...
/// subscription.cancel();
/// ```
DistinctValueConnectableObservable<T> publishValueSeededDistinct<T>(
  Observable<T> this$, {
...
/// ```
ValueObservable<T> shareValueDistinct<T>(
  Observable<T> this$, {
  bool equals(T previous, T next),
}) {
  return publishValueDistinct(
    this$,
    equals: equals,
  ).refCount();
}
...
/// subscription2.cancel();
/// ```
ValueObservable<T> shareValueSeededDistinct<T>(
  Observable<T> this$, {
  @required T seedValue,
  bool equals(T previous, T next),
}) {
